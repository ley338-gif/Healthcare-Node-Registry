...
final class UpdateDicomConnectionRequest extends FormRequest
{
    public function authorize(): bool
    {
        $connection = $this->route('dicomConnection');

        return $connection instanceof DicomConnection
            && (
                $this->user()?->can(
                    'update',
                    $connection,
    ...
    {
        /** @var DicomConnection|null $connection */
        $connection = $this->route('dicomConnection');
