...
final class StoreSystemNetworkInterfaceRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('update', $this->route('system'));
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'interface_label' => ['required', 'string', 'max:160', Rule::unique('system_network_interfaces')->where('system_id', $system->id)],
